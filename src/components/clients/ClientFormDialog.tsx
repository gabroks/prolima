...
function isFormDirty(form: ClientForm): boolean {
  return !!(form.name || form.phone || form.document || form.email || form.contact || form.city || form.address || form.neighborhood || form.razaoSocial || form.nomeFantasia);
}
