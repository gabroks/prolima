...
import { FilePlus, UserPlus, Receipt, DollarSign, Truck, CreditCard } from "lucide-react";
...
const quickActions = [
  ...
  { label: "Registrar Pagamento", shortLabel: "Pagamento", icon: CreditCard, href: "/financeiro" },
