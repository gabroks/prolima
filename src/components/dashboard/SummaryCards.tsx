        ...
        >
          <CardContent className="p-3.5 sm:p-5">
            <div className="flex items-start justify-between mb-2 sm:mb-3">
              <div className="p-1.5 sm:p-2 rounded-lg bg-primary/10 text-primary group-hover:bg-primary group-hover:text-primary-foreground transition-colors duration-200">
            ...
            <div className="text-lg sm:text-2xl font-bold tracking-tight tabular-nums">{card.value}</div>
