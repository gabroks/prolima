...
function isFormDirty(form: SupplierForm): boolean {
  return !!(form.name || form.document || form.phone || form.email || form.city || form.address || form.neighborhood || form.notes);
}
